...
describe('routing', () => {
  ...
  it('should render admin capabilities page', async () => {
    await renderWithRouter('/projects/acme-corp/admin/capabilities')
    await waitFor(() => {
  ...
  it('should render admin company model page', async () => {
    await renderWithRouter('/projects/acme-corp/admin/company-model')
    await waitFor(() => {
  ...
  it('should render admin contracts page', async () => {
    await renderWithRouter('/projects/acme-corp/admin/contracts')
    await waitFor(() => {
  ...
  it('should render admin workflows page', async () => {
    await renderWithRouter('/projects/acme-corp/admin/workflows')
    await waitFor(() => {
  ...
  it('should render admin releases page', async () => {
    await renderWithRouter('/projects/acme-corp/admin/releases')
    await waitFor(() => {
  ...
  it('should render admin validations page', async () => {
    await renderWithRouter('/projects/acme-corp/admin/validations')
    await waitFor(() => {
  ...
  it('should render admin audit page', async () => {
    await renderWithRouter('/projects/acme-corp/admin/audit')
    await waitFor(() => {
