...
describe('resolveEntityRoute', () => {
  ...
  it('resolves company to org route', () => {
    const result = resolveEntityRoute(projectSlug, 'company', projectSlug)
  ...
  it('resolves department to L2 route (direct navigation)', () => {
    const result = resolveEntityRoute(projectSlug, 'department', 'dept-123')
    expect(result).toEqual({
  ...
  it('resolves workflow to L3 route (direct navigation)', () => {
    const result = resolveEntityRoute(projectSlug, 'workflow', 'wf-456')
    expect(result).toEqual({
  ...
  it('resolves role with parent dept to L2 of dept + focusNodeId', () => {
    const result = resolveEntityRoute(projectSlug, 'role', 'role-1', 'dept-abc')
    expect(result).toEqual({
  ...
  it('resolves capability with parent dept to L2 + focus', () => {
    const result = resolveEntityRoute(projectSlug, 'capability', 'cap-1', 'dept-abc')
    expect(result).toEqual({
      path: '/projects/proj-1/departments/dept-abc',
  ...
  it('resolves agent-archetype with parent dept to L2 + focus', () => {
    const result = resolveEntityRoute(projectSlug, 'agent-archetype', 'arch-1', 'dept-abc')
    expect(result).toEqual({
      path: '/projects/proj-1/departments/dept-abc',
  ...
  it('resolves agent-assignment with parent dept to L2 + focus', () => {
    const result = resolveEntityRoute(projectSlug, 'agent-assignment', 'asn-1', 'dept-abc')
    expect(result).toEqual({
      path: '/projects/proj-1/departments/dept-abc',
  ...
  it('resolves skill with parent dept to L2 + focus', () => {
    const result = resolveEntityRoute(projectSlug, 'skill', 'skill-1', 'dept-abc')
    expect(result).toEqual({
      path: '/projects/proj-1/departments/dept-abc',
  ...
  it('resolves role without parent dept to org L1 + focus', () => {
    const result = resolveEntityRoute(projectSlug, 'role', 'role-1')
    expect(result).toEqual({
      path: '/projects/proj-1/org',
      focusNodeId: 'role:role-1',
    })
  ...
  it('resolves contract to org L1 + focus (no parent dept)', () => {
    const result = resolveEntityRoute(projectSlug, 'contract', 'ct-1')
    expect(result).toEqual({
      path: '/projects/proj-1/org',
  ...
  it('resolves policy to org L1 + focus', () => {
    const result = resolveEntityRoute(projectSlug, 'policy', 'pol-1')
    expect(result).toEqual({
      path: '/projects/proj-1/org',
  ...
  it('resolves workflow-stage to org L1 + focus', () => {
    const result = resolveEntityRoute(projectSlug, 'workflow-stage', 'stg-1')
    expect(result).toEqual({
      path: '/projects/proj-1/org',
