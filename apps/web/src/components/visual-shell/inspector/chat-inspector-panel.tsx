...
export function ChatInspectorPanel() {
  ...
  const conversationStatus = conversation?.status ?? 'not-started'

  return (
    <div data-testid="chat-inspector-panel" className="space-y-4 p-3">
      {/* Bootstrap Status */}
      <div data-testid="chat-inspector-bootstrap">
      ...
      {/* Project Documents */}
      <div data-testid="chat-inspector-documents">
        <h4 className="mb-1.5 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
            ...
            {documents.map((doc) => (
              <li key={doc.id}>
                <button
                  ...
                  data-testid="chat-inspector-doc-link"
                >
      ...
      {/* Pending Proposals */}
      <div data-testid="chat-inspector-proposals">
        <h4 className="mb-1.5 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
          ...
          <ul className="space-y-1">
            {pendingProposals.map((p) => (
              ...
              >
                ...
                <span className="ml-1 shrink-0 rounded bg-blue-50 px-1.5 py-0.5 text-[10px] font-medium text-blue-700">
                  {p.proposalType}
                </span>
              </li>
            ))}
      ...
      {/* Runtime Summary */}
      <div data-testid="chat-inspector-runtime">
        <h4 className="mb-1.5 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
        ...
        <div className="flex items-center gap-1.5 mb-1.5">
          <span
            data-testid="chat-inspector-connection-dot"
