/**
 * Legacy Verticaler Bootstrap Service.
 *
 * Renamed from bootstrap.service.ts as part of LCP-013.
 * Seeds the pre-defined Verticaler reference company.
 * Will be deprecated by LCP-016 when Verticaler moves to CEO-first bootstrap.
 */
...
@Injectable()
export class LegacyBootstrapService implements OnModuleInit {
  private readonly logger = new Logger(LegacyBootstrapService.name)
