# Lenguaje visual y gramática de TheCrew (v1) — DRAFT

> **Superseded by:** `docs/11-visual-grammar-v1-spec.md` (VIS-002 formal spec).
> This file remains as the original draft for reference.
